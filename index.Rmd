...
The quality indicators hereby implemented have as reference the following documents: the [Statistical Standard Series - Quality Indicators to Be Disseminated to External Users](http://intranet.fao.org/fileadmin/user_upload/scp/Standards_for_quality_compliance/SSS_Quality_Indicators_to_Be_Disseminated_to_External_Users__endorsed_December_2019_.pdf) document produced by the Office of the Chief Statistician (OCS) and endorsed by the Interdepartmental Working Group (IDWG) on Statistics and the [Quality Indicators - FAO ESS review for questionnaire-based FAOSTAT domains](documentation/Quality_indicators_DRAFT_v20190628 (003).docx), which contains the ready-to-use quality indicators, based on the previous document.
